...
\item Bisectors of the angles B and C of an isosceles triangle with AB=AC intersect each other at O. BO is produced to a point M. Prove that $\angle$MOC=$\angle$ABC.
\begin{figure}[h]
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[scale=0.5]{Figure4}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[scale=0.08]{Figure5}
	\end{subfigure}
\end{figure}
\item Bisectors of the angle B and C of an isosceles triangle ABC with AB=AC intersect each other at O. Show that the external angle adjacent to $\angle$ABC is equal to $\angle$BOC.
